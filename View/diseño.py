...
"")
        icon = QIcon()
        icon.addFile("../imagenes/barra-de-menus.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        icon1 = QIcon()
        icon1.addFile("../imagenes/minimizar.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        icon2 = QIcon()
        icon2.addFile("../imagenes/restaurar.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        icon3 = QIcon()
        icon3.addFile("../imagenes/maximizar.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        icon4 = QIcon()
        icon4.addFile("../imagenes/cerrar.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon5 = QIcon()
        icon5.addFile("../imagenes/inteligencia-artificial.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile("../imagenes/base-de-datos.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile("../imagenes/chip.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile("../imagenes/moto.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon9 = QIcon()
        icon9.addFile("../imagenes/encriptado.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.label.setPixmap(QPixmap(u"../imagenes/imagen_dos.png"))
